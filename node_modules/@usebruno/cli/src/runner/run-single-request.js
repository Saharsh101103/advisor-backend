...
const { isUndefined, isNull, each, extend, get } = require('lodash');
...
const runSingleRequest = async function (
  ...
  try {
    ...
    request.runnerIterationDetails = collection?.runnerIterationDetails;
    ...
    if (requestScriptFile?.length) {
      ...
      if (result?.skipRequest) {
        console.log(chalk.red(stripExtension(relativeItemPathname)) + chalk.dim(` (request skipped via pre-request script)`));
        return {
          test: {
